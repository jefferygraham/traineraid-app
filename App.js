...
const DrawerNavigation = () => {
  return (
    ...
    >
      <Drawer.Screen name="Home" component={homeScreen} options={{ ...TransitionPresets.DefaultTransition, }} />
    </Drawer.Navigator>
  )
}
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="MainDrawer" component={DrawerNavigation} options={{ ...TransitionPresets.DefaultTransition }} />
        ...
        <Stack.Screen name="SelectDateAndTime" component={selectDateAndTimeScreen} />
