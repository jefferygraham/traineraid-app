...
const CustomDrawer = (props) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <DrawerContentScrollView
                {...props}
                contentContainerStyle={{ flexGrow: 1, backgroundColor: Colors.primaryColor, }}
    ...
    function drawerOptions() {
        return (
            <>
                {drawerOptionSort({ iconName: 'home', option: 'Home', navigateTo: 'Home' })}
                {drawerOptionSort({ iconName: 'security', option: 'My Bookings', navigateTo: 'MyBooking' })}
                {drawerOptionSort({ iconName: 'directions-car', option: 'MyCars', navigateTo: 'MyCars' })}
                {drawerOptionSort({ iconName: 'favorite', option: 'Favorites', navigateTo: 'Favorites' })}
                {drawerOptionSort({ iconName: 'location-on', option: 'My Address', navigateTo: 'MyAddresses' })}
                {drawerOptionSort({ iconName: 'email', option: 'Contact us', navigateTo: 'ContactUs' })}
                {drawerOptionSort({ iconName: 'settings', option: 'Settings', navigateTo: 'Settings' })}
                <TouchableOpacity
                    activeOpacity={0.9}
